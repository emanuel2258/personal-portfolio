  ...
  return (
    <main className="body">
      <div class="container text-center">
        <div class="row align-items-start" style={{ marginBottom: "50px" }}>
          <h1>Welcome! 👋</h1>
        </div>
        <div class="row align-items-center" style={{ marginBottom: "60px" }}>
          <div class="col">
            <img
              src={process.env.PUBLIC_URL + "/images/headshot.JPG"}
              class="rounded container-md"
              alt="Emanuel's headshot"
            />
          </div>
          <div class="col container-sm">
            <p>
              I am Emanuel, and I'm thrilled to share a little bit about myself.
              I am a Puerto Rican 🇵🇷 with a diverse range of interests and
              passions.
            </p>

            <p>
              I am a <code>programmer</code> 👨‍💻 and I have a love for coding and
              problem-solving, constantly exploring new technologies to expand
              my skills. Whether it's building innovative applications or
              designing efficient algorithms, I find great satisfaction in the
              world of programming.
            </p>

            <p>
              Outside of the digital realm, I am also an avid{" "}
              <code>gardener</code> 🌱. There's something incredibly fulfilling
              about nurturing and tending to plants, watching them grow and
              flourish under my care. Whether it's cultivating beautiful flowers
              or growing my own fruits and vegetables, I find solace and joy in
              the natural world.
            </p>
            <p>
              Additionally, I am a dedicated <code>student</code> 🎓, always
              seeking opportunities to expand my knowledge and grow both
              personally and professionally. I have a thirst for learning and
              take great pleasure in engaging with new subjects, exploring
              different fields, and embracing the challenges that come with
              acquiring new skills.
            </p>
            <p>
              Beyond my intellectual pursuits, I am also a devoted{" "}
              <code>meditator</code> 🧘. I believe in the power of mindfulness
              and regularly set aside time to find inner calm and clarity.
              Through meditation, I cultivate a sense of peace, balance, and
              self-awareness that positively impacts all aspects of my life.
            </p>

            <h3>Fluent 🗣️ Spanish and English</h3>
          </div>
        </div>
